...
The goal of the project, is to simulate multiple coders competing for limited shared resources (USB dongles) while avoiding:
...
- gettimeofday Documentation  
  ...
  - http://drmdh.free.fr/stad/SoftDir/C/Cours/cours15.htm
...
All implementation logic, debugging, testing, and final code integration were written manually.